...
const contactOptions = [
  ...
  },
  {
    ...
    action: "github.com/RimaNafougui/MealMatch",
    href: "https://github.com/RimaNafougui/MealMatch/issues",
      ...
      <div className="flex flex-col gap-16 py-12">
        ...
        <section className="text-center flex flex-col items-center gap-4">
          ...
          <h1 className="text-4xl lg:text-6xl font-bold tracking-tight">
            Comment pouvons-nous <span className="text-success">t'aider ?</span>
          </h1>
              ...
              <Card className="p-6 border border-success/30 bg-success/5">
                <CardBody className="items-center text-center gap-3 p-2">
                  ...
                  <p className="text-default-500 text-sm">
                    Merci de nous avoir contactés. Nous te répondrons dans les
                    plus brefs délais.
                  </p>
                  <Button
                    variant="flat"
