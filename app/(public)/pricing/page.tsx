    ...
    <div className="flex flex-col gap-16 py-12">
      ...
      <section className="text-center flex flex-col items-center gap-4">
        ...
        <h1 className="text-4xl lg:text-6xl font-bold tracking-tight">
          Simple et{" "}
          <span className="text-success">transparent</span>
        </h1>
          ...
          >
            ...
            <CardBody className="flex flex-col gap-2 py-4">
              ...
              {plan.unavailable.map((feature, i) => (
                <div key={i} className="flex items-center gap-2 text-sm text-default-400 line-through">
      ...
      <section className="flex flex-col gap-8 max-w-3xl mx-auto w-full">
        ...
        <div className="flex flex-col gap-4">
          {faq.map((item, index) => (
            <Card key={index} className="p-4 border border-divider/50 bg-white/50 dark:bg-black/20">
        ...
        <Card className="bg-gradient-to-r from-green-400 to-green-500 p-12 text-center border-none">
          <CardBody className="gap-6 items-center justify-center">
            ...
            <div className="flex gap-3">
              ...
              <Button as={Link} href="/support" size="lg" variant="bordered" className="text-white border-white">
